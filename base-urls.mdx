...
|--------|----------|---------------|
| **US East** | `https://us-east-api.roxom.com` | `wss://us-east-api.roxom.com/ws` |
| **US West** | `https://us-west-api.roxom.com` | `wss://us-west-api.roxom.com/ws` |
| **Europe** | `https://eu-api.roxom.com` | `wss://eu-api.roxom.com/ws` |
| **Asia Pacific** | `https://ap-api.roxom.com` | `wss://ap-api.roxom.com/ws` |

<Note>
  Use the global endpoint `https://api.roxom.com` if you're unsure which region to choose. The global endpoint automatically routes requests to the optimal region.
</Note>
