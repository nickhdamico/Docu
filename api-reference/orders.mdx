...
| `type` | string | Yes | Order type: "MARKET", "LIMIT", "STOP", "STOP_LIMIT" |
| `quantity` | string | Yes | Order quantity |
| `price` | string | No | Price (required for LIMIT and STOP_LIMIT) |
| `stop_price` | string | No | Stop price (required for STOP and STOP_LIMIT) |
