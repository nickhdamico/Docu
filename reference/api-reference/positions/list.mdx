...
<ParamField query="unit" type="string" default="sats">
...
<RequestExample>
```bash cURL
curl -X GET "https://api.roxom.com/api/v1/positions?instType=perpetual&symbol=SP500-BTC&unit=sats" \
...
const response = await fetch('https://api.roxom.com/api/v1/positions?instType=perpetual&symbol=SP500-BTC&unit=sats', {
  headers: {
    'X-API-Key': 'your_api_key_here',
    'Content-Type': 'application/json'
  }
...
<ResponseField name="data" type="array">
  ...
  <Expandable title="Position properties">
    ...
    <ResponseField name="size" type="integer">
      Position size in contract unit
    </ResponseField>
