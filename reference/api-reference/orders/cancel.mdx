...
const result = await response.json();
console.log('Cancelled order IDs:', result.data.cancelledOrderIds);
```
</RequestExample>
...
<ResponseField name="data" type="object">
  ...
  <Expandable title="Bulk cancellation properties">
    <ResponseField name="cancelledOrderIds" type="array">
      Array of UUIDs for the orders that were cancelled
    </ResponseField>
  </Expandable>
</ResponseField>
