...
<Warning>
  Account update streams require authentication. Include a valid API key in the WebSocket connection headers (`X-API-Key`). Timestamp/signature headers are not enforced yet.
</Warning>
