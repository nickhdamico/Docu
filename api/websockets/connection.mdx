...
wscat -c wss://ws.roxom.com/ws \
  ...
  --header "X-API-Signature: generated-hmac-signature"
```
</CodeGroup>

### HMAC Signature Generation

The `X-API-Signature` header must contain an HMAC-SHA256 signature of the timestamp:
...
// Usage
const client = new RoxomWebSocket('wss://ws.roxom.com/ws', {
  headers: {
    'X-API-Key': 'your-api-key',
...
# Usage
client = RoxomWebSocketClient('wss://ws.roxom.com/ws', 'your-api-key')
client.connect()
```
...
const PRODUCTION_WS_URL = 'wss://ws.roxom.com/ws';
...
```javascript Sandbox
const SANDBOX_WS_URL = 'wss://ws.roxom.io/ws';
