...
| --- | --- |
| **Underlying Index Price** | • **Gold Price:** real-time **PAX Gold (PAXG)** calculated as the 4-hour V-WAP across Binance (PAXG/USDT); Binance (PAXG/USDC), and Coinbase (PAXG/USD). • **BTC Price:** 3-venue 4-hour V-WAP spot composite of Binance (BTC/USDT); Bybit (BTC/USDT); Coinbase (BTC/USD). |
