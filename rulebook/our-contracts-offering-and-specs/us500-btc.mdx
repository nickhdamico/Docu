---
title: "US500-BTC"
description: Below are the specific details for US500-BTC perpetual futures.
---

| **Contract Code** | `US500-PERP` |
| --- | --- |
| **Underlying Indices** | • **Equity leg:** Composite price for the **SPDR S&P 500 ETF (SPY)** from primary-listing venues • **BTC Price:** 3-venue 4-hour V-WAP spot composite of Binance (BTC/USDT); Bybit (BTC/USDT); Coinbase (BTC/USD). |
...
| **Underlying Cash‑Market Hours** | **Monday – Friday** • **Pre‑Market:** 04:00 – 09:30 ET • **Regular Session:** 09:30 – 16:00 ET • **After‑Hours:** 16:00 – 20:00 ET _(NYSE Arca consolidated tape; closed on U.S. market holidays)._ |
...
| **Price Formation when the underlying equity market is closed** | • **Equity leg (SPY):** When U.S. equity exchanges are closed, the equity‑leg reference is **frozen at the last official SPY print** (primary‑listing venues' closing last price). • **BTC leg:** The BTC component continues to update in real time using our 3‑venue 4‑hour VWAP composite (Binance BTC/USDT, Bybit BTC/USDT, Coinbase BTC/USD). • **Mark Price:** mark price is calculated in the same way a the normal trading hours, where each _P_ is computed with the **static SPY close** and the **live BTC composite**. |
