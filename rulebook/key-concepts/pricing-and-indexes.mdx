---
description: >-
  Here we define how Roxom calculates fair prices and how each contract's Underlying Asset is sourced, then combined with BTC/USDT data to produce our BTC Denominated Index Price.
---
